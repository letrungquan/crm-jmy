...
import { ReExamination } from '../types';
import { DOCTORS } from '../constants';

interface CompleteReExamModalProps {
...
const CompleteReExamModal: React.FC<CompleteReExamModalProps> = ({ reExam, onClose, onConfirm }) => {
  ...
  useEffect(() => {
    // Fill initial data from the re-examination prediction
    if (reExam) {
        setActualRevenue(reExam.potentialRevenue ? reExam.potentialRevenue.toString() : '');
        setActualService(reExam.service || '');
        setDoctorName(reExam.doctorName || '');
    }
  }, [reExam]);
...
export default CompleteReExamModal;
